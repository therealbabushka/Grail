...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-none border-t border-border/50 p-4 group-data-[size=sm]/card:p-3",
        className
      )}
      {...props}
    />
